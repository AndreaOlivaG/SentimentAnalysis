...
def quitar_vacias(texto):
    ...
    f = open("opiniones_procesadas.txt", "a")
    tokens = ""
...
if __name__ == "__main__":
    ...
    with open("opiniones.txt", "r") as f: # Se lee el fichero de opiniones y se almacenan en una lista
        lines = f.readlines()
        f.close()
    ...
    with open("traduccion.txt", "r") as f: # Se lee el fichero de opiniones y se almacenan en una lista
        lines = f.readlines()
        f.close()
